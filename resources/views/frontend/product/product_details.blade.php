...
<div class="breadcrumb">
    <div class="container">
        <div class="breadcrumb-inner">
            <!-- add you category and subcategory -->
                        ...
                        <div class='col-sm-6 col-md-7 product-info-block'>
                            <div class="product-info">
                                ...
                                <h1 class="name" id="pname">
                                    @if(session()->get('locale') == 'ar') {{ $product->product_name_ar }} @else
                                ...
                                <div class="description-container m-t-20">
                                    @if(session()->get('locale') == 'ar') {{ $product->short_descp_ar }} @else
                            ...
                            <div class="tab-content">
                                ...
                                <div id="description" class="tab-pane in active">
                                    <div class="product-tab">
                                        <p class="text">@if(session()->get('locale') == 'ar')
                                            {!! $product->long_descp_ar !!} @else {!! $product->long_descp_en !!}
                                            @endif</p>
                                    </div>
                                </div><!-- /.tab-pane -->
